...
public class Afrodite_State_3 : Afrodite_State {
    private float _timeToSwitchState = 8f;
    private float _switchStateTimer;
    private float _timeToFirstWaveShoot = 0.08f;
    private float _firstWaveShootTimer;
    private float _timeToSecondWaveShoot = 0.08f;
    ...
    private void HandleAttack(Afrodite context) {
    ...
    private void GenerateBullet(Transform bulletStartingPos, GameObject bulletPrefab, Transform projectileDir, Afrodite context) {
